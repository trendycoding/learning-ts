...
const listDirContentsSync_1 = require("./commands/listDirContentsSync");
...
(0, clear_1.default)();
console.log(chalk_1.default.blue(figlet_1.default.textSync('DIR MANAGER. By David', { horizontalLayout: 'full' })));
...
if (options.ls) {
    ...
    (0, listDirContentsSync_1.listDirContentsSync)(filepath);
}
if (options.mkdir) {
